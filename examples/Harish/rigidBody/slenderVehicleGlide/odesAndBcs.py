...
def odes(tau, X, params, aux):
    ...
    u = fsolve(controlFun, 0.1, args=(states, t, epsi), fprime=None, full_output=0, \
    ...
    *fz + sin(gam - theta)*fx)/(v*v0*((4*densityWarhead*rWarhead**3*pi)/3 - \
    ...
    XDot = tf*numpy.array([vdot,gamdot,hdot,sdot,thetadot,wdot,cdot,lamvdot,lamgamdot,lamhdot,lamthetadot,lamwdot,lamcdot])
    return XDot
